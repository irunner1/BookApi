...
- 🎯 Entry points to execute your program using `python -m <bookapi>` or `$ bookapi` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/irunner1/BookApi/branch/main/graph/badge.svg?token=BookApi_token_here)](https://codecov.io/gh/irunner1/BookApi)
[![CI](https://github.com/irunner1/BookApi/actions/workflows/main.yml/badge.svg)](https://github.com/irunner1/BookApi/actions/workflows/main.yml)

Awesome bookapi created by irunner1

## Install

from source
```bash
git clone https://github.com/irunner1/BookApi bookapi
cd bookapi
make install
```
...
```bash
$ bookapi run --port 8080
```

or

```bash
python -m bookapi run --port 8080
```
...
```bash
❯ bookapi --help
Usage: bookapi [OPTIONS] COMMAND [ARGS]...
...
```bash
❯ bookapi create-user --help
Usage: bookapi create-user [OPTIONS] USERNAME PASSWORD
...
```bash
bookapi create-user admin admin --superuser
```
...
Run with `bookapi run` and access http://127.0.0.1:8000/docs

![](https://raw.githubusercontent.com/rochacbruno/fastapi-project-template/master/docs/api.png)


**For some api calls you must authenticate** using the user created with `bookapi create-user`.
...
-----------------------------------------------------
bookapi/__init__.py              4      0   100%
bookapi/app.py                  16      1    94%
bookapi/cli.py                  21      0   100%
bookapi/config.py                5      0   100%
bookapi/db.py                   10      0   100%
bookapi/models/__init__.py       0      0   100%
bookapi/models/content.py       47      1    98%
bookapi/routes/__init__.py      11      0   100%
bookapi/routes/content.py       52     25    52%
bookapi/routes/security.py      15      1    93%
bookapi/routes/user.py          52     26    50%
bookapi/security.py            103     12    88%
-----------------------------------------------------
TOTAL                               336     66    80%
...
> `dynaconf_merge` is a boolean that tells if the settings should be merged with the default settings defined in bookapi/default.toml.
